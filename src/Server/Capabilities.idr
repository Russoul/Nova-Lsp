...
decor : List TermAnn
decor = [TypAnn, KeywordAnn, LetVarAnn, BoundVarAnn, UnsolvedMetaAnn, SolvedMetaAnn, CommentAnn, ElimAnn, ElemAnn]

encodeDecorAsString : TermAnn -> String
encodeDecorAsString TypAnn          = "typ"
encodeDecorAsString KeywordAnn      = "keyword"
encodeDecorAsString LetVarAnn       = "let_var"
encodeDecorAsString BoundVarAnn     = "bound_var"
encodeDecorAsString UnsolvedMetaAnn = "unsolved_meta"
encodeDecorAsString SolvedMetaAnn   = "solved_meta"
encodeDecorAsString CommentAnn      = "comment"
encodeDecorAsString ElimAnn         = "elim"
encodeDecorAsString ElemAnn         = "elem"

||| Convert Decoration to legend index
export
encodeDecorAsNum : TermAnn -> Int
encodeDecorAsNum TypAnn           = 0
encodeDecorAsNum KeywordAnn       = 1
encodeDecorAsNum LetVarAnn        = 2
encodeDecorAsNum BoundVarAnn      = 3
encodeDecorAsNum UnsolvedMetaAnn  = 4
encodeDecorAsNum SolvedMetaAnn    = 5
encodeDecorAsNum CommentAnn       = 6
encodeDecorAsNum ElimAnn          = 7
encodeDecorAsNum ElemAnn          = 8
...
serverInfo = MkServerInfo { name = "hott-lsp", version = Just "0.1" }
